...
val GitHubApps = listOf(
    ...
    GitHubApp("com.android.azyx", "reyyuuki", "Azyx"),
    ...
    GitHubApp("com.freedom.guard", "Freedom-Guard", "FG_MOBILE"),
    ...
    GitHubApp("com.github.NPSReact", "100Daisy", "NPSReact"),
    ...
    GitHubApp("com.innomatic.jacto", "innomatica", "jacto"),
    GitHubApp("com.innomatic.libro", "innomatica", "libro"),
    ...
    GitHubApp("com.kodjodevf.mangayomi", "kodjodevf", "mangayomi"),
    GitHubApp("com.kpstv.yts", "KaustubhPatange", "Moviesy"),
    ...
    GitHubApp("com.peer_to_peer.app", "jamessizeland", "peer-to-peer"),
    ...
    GitHubApp("com.quietmobile", "TryQuiet", "quiet"),
    ...
    GitHubApp("com.sjyd.nightscreen", "SkyD666", "NightScreen"),
    ...
    GitHubApp("com.yuyan.pinyin.offline_release", "gurecn", "YuyanIme"),
    ...
    GitHubApp("io.legado.app.release", "gedoor", "legado"),
    GitHubApp("io.unsigned.sideband", "markqvist", "Sideband"),
    ...
    GitHubApp("network.bisq.mobile.node", "bisq-network", "bisq-mobile"),
    ...
    GitHubApp("org.stjr.srb2", "Lactozilla", "SRB2"),
    GitHubApp("org.tawhid.readout", "tawhidmonowar", "ReadOut"),
    GitHubApp("org.telegram.messenger.beta", "Telegram-FOSS-Team", "Telegram-FOSS"),
    GitHubApp("org.ultimatum.ultimatum", "gonzazoid", "ultimatum"),
    ...
    GitHubApp("org.zaps166.QMPlay2", "zaps166", "QMPlay2"),
    ...
    GitHubApp("ro.aenigma", "m3sserschmitt", "aenigma-android"),
